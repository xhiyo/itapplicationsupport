    ...
    return (
        ...
        >
            ...
            <div className={`px-6 flex items-center gap-3 overflow-hidden transition-all duration-[400ms] ease-in-out mb-8`}>
                <div className="flex items-center justify-center shrink-0 w-10 h-10 bg-white dark:bg-slate-900 rounded-xl relative overflow-hidden">
                ...
                {items.map((item, index) => {
                    ...
                    return (
                        <button
                            ...
                            className={`w-full flex items-center rounded-xl text-left transition-all duration-300 ease-out px-3 py-3 group relative overflow-hidden ${isActive
            ...
            <div className="mt-auto px-4 flex flex-col gap-4 overflow-hidden shrink-0 pb-2">
                {/* Profile Section */}
                <div className="flex items-center justify-between p-2 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                    <div className="flex items-center gap-3 overflow-hidden transition-all duration-[400ms] ease-in-out">
                        <div className={`text-left flex flex-col overflow-hidden transition-all duration-[400ms] ease-in-out ${isOpen ? "opacity-100 translate-x-0 w-[180px]" : "opacity-0 -translate-x-2 w-0"}`}>
                            <h4 className="text-[13px] font-bold text-slate-800 dark:text-white leading-tight flex justify-center whitespace-nowrap">IT Application Support Team</h4>
                        </div>
                    </div>
                </div>
                ...
                <button
                    ...
                    className="w-full flex items-center rounded-xl text-left transition-all duration-300 ease-out px-3 py-3 group relative overflow-hidden text-red-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20"
                >
